...
public class ProjectService : IProjectService
{
    ...
    [
        new ProjectDto { Id = 1, Slug = "fintech-platform", Title = "FinTech Platform", Category = "Web Development", Description = "A comprehensive financial technology platform with real-time trading, portfolio management, and advanced analytics.", Client = "FinCorp Inc.", Image = "assets/images/gallery/1.jpg", Technologies = [".NET 9", "React", "Azure", "SQL Server"] },
        ...
        new ProjectDto { Id = 3, Slug = "ecommerce-solution", Title = "E-Commerce Solution", Category = "Web Development", Description = "High-performance e-commerce platform supporting 50k+ daily transactions.", Client = "ShopGlobal", Image = "assets/images/gallery/3.jpg", Technologies = ["Blazor", "EF Core", "Azure"] },
        new ProjectDto { Id = 4, Slug = "ai-analytics-dashboard", Title = "AI Analytics Dashboard", Category = "AI Solutions", Description = "Business intelligence platform with machine learning-powered forecasting.", Client = "DataDriven Ltd.", Image = "assets/images/gallery/4.jpg", Technologies = ["Python", "TensorFlow", "Power BI"] },
        new ProjectDto { Id = 5, Slug = "cloud-migration", Title = "Cloud Migration Project", Category = "Cloud Solutions", Description = "Enterprise legacy system migration to Azure with zero downtime.", Client = "RetailMax", Image = "assets/images/gallery/5.jpg", Technologies = ["Azure", "Kubernetes", "Terraform"] },
